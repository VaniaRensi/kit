...
python .claude/ai-kit-base/design-system/scripts/search-slides.py "investor pitch" -d strategy

# Get emotion arc
python .claude/ai-kit-base/design-system/scripts/search-slides.py "series a funding" -d strategy --json
```
