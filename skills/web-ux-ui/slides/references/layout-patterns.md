...
python .claude/ai-kit-base/design-system/scripts/search-slides.py "metrics dashboard" -d layout

# Contextual recommendation
python .claude/ai-kit-base/design-system/scripts/search-slides.py "traction slide" \
