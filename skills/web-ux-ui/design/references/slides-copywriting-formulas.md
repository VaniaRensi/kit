...
python .claude/ai-kit-base/design-system/scripts/search-slides.py "problem agitation" -d copy

# Get emotion-appropriate formula
python .claude/ai-kit-base/design-system/scripts/search-slides.py "urgency cta" -d copy
```
