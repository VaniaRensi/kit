...
|-------|---------|-----------|
| brand | Brand identity, voice, assets | INSTRUCTIONS.md + 10 references + 3 scripts |
| design-system | Token architecture, specs | INSTRUCTIONS.md + 7 references + 2 scripts |
| ui-styling | Component implementation | INSTRUCTIONS.md + 7 references + 2 scripts |
| logo-design | AI logo generation (55 styles, 30 palettes) | INSTRUCTIONS.md + 4 references + 2 scripts |
| cip-design | Corporate Identity Program (50 deliverables) | INSTRUCTIONS.md + 3 references + 3 scripts |
| slides | HTML presentations with Chart.js | INSTRUCTIONS.md + 4 references |
| banner-design | Banners for social, ads, web, print (22 styles) | INSTRUCTIONS.md + 1 reference |
| icon-design | SVG icon generation (15 styles, Gemini 3.1 Pro) | INSTRUCTIONS.md + 1 reference + 1 script |
...
**Brand:**
```bash
node .claude/ai-kit-base/brand/scripts/inject-brand-context.cjs
node .claude/ai-kit-base/brand/scripts/validate-asset.cjs <path>
```

**Tokens:**
```bash
node .claude/ai-kit-base/design-system/scripts/generate-tokens.cjs -c tokens.json
node .claude/ai-kit-base/design-system/scripts/validate-tokens.cjs -d src/
```
