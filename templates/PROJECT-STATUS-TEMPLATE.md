...
**🚨 SACRED KIT RULE:** The `kit/skills/` folder is a READ-ONLY library. Do NOT modify files inside `kit/skills/`. All project documentation must use the `PROJECT_ID` prefix (e.g., `CLEAN-HISTORY.md`) and stay in the root or source folders.
